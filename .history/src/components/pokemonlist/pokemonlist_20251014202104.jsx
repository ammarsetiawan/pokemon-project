...
function PokemonList() {
  ...
  return (
    ...
    <a className="nav"href="#about">About</a>
      ...
      <div  className="im">
<img className="i" src="/src/assets/Gemini_Generated_Image_rcj1qlrcj1qlrcj1-removebg-preview.png" alt="" />
          
      </div>
      <input type="text" placeholder="cari pokemon..." className="search" onChange={handleSearch} />
      <div className="list-pokemon">
        {filterPokemons.length == 0 ? (
          <div justify-content="centerr">data tidak ditemukan <br/>silahkan cari pokemon yang lain</div>
        ) : (
