...
<div className="text-footer">
  ...
  programing <span>(AMMAR)</span></div>
<div className="button-footer">
  {/* <!-- From Uiverse.io by PapaUiiss404 -->  */}
<div class="card">
  <a class="socialContainer containerOne" href="https://www.instagram.com/amrs0_9/" target="_sefl">
  ...
  <a class="socialContainer containerTwo" href="#">.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"></path> </svg>              </a>
