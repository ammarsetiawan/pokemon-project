    ...
    <a className="nav"href="#about">About</a>
      ...
      <div className="list-pokemon">
        {filterPokemons.length == 0 ? (
          <div >data tidak ditemukan silahkan cari pokemon yang lain</div>
        ) : (
...
<div class="card">
  ...
  <a class="socialContainer containerFour" href="#https://api.whatsapp.com/send/?phone=6282113051867&text&type=phone_number&app_absent=0https://wa.me/6282113051867">
